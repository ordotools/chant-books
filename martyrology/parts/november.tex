...
\selectlanguage{latin}
	\rubric{Si dies secunda Novembris incidat in Dominicam, prædicta verba
	leguntur primo loco, die sequenti.}
\switchcolumn
\selectlanguage{english}
	\rubric{If the second day of November should occur on a Sunday, the above
	words are omitted and read instead at the beginning on the following day.}
\switchcolumn*
...
\selectlanguage{latin}
\rubric{In ipsa die Commemorationis omnium Fidelium Defunctorum, antequam legantur Nonæ:}
\switchcolumn
\selectlanguage{english}
...
\selectlanguage{latin}
Hac die Commemorátio ómnium Fidélium Defunctórum; in qua commúnis pia Mater
Ecclésia, postquam univérsos fílios suos jam in cælo lætántes cóngruis stúduit
celebráre præcóniis, mox et omnes adhuc in Purgatório geméntes válidis apud
Dóminum et Sponsum Christum sátagit suffrágiis adjuváre, ut quam cítius váleant
ad societátem supernórum cívium perveníre.
\switchcolumn
\selectlanguage{english}
English translation...
\switchcolumn*
...
\selectlanguage{latin}
\rubric{Postea dicitur: \black{Tértio,} vel \black{Prídie nonas Novémbris,
Luna\dots,} et continuatur Lectio usque ad finem, more solito.}
\switchcolumn
\selectlanguage{english}
\rubric{After which is read: \black{The Third,} or \black{The Fourth Day of
November, the\dots\ Day of the Moon,} and the rest in the usual manner.}
\switchcolumn*
...
% \switchcolumn*
\selectlanguage{latin}
	\lettrine[lines=2]{M}{edioláni} natális sancti Cároli Borromæi Cardinális,
	Epíscopi Mediolanénsis et Confessóris, quem, sanctitáte conspícuum et
	miráculis clarum, Paulus Papa Quintus in Sanctórum númerum rétulit. Ipsíus
	tamen festívitas sequénti die celebrátur.
\switchcolumn
\selectlanguage{english}
	\lettrine[lines=2]{A}{t} Milan, St. Charles Borromeo, cardinal, bishop of
	that city, and confessor, who was ranked among the saints by Paul V for the
	holiness of his life and for his renown for miracles. His feast is observed
...
\begin{paracol}{2}
\selectlanguage{latin}
	\lettrine[lines=2]{S}{ancti} Cároli Borromæi Cardinális, Epíscopi
	Mediolanénsis et Confessóris, qui migrávit in cælum prídie hujus diéi.
\switchcolumn
\selectlanguage{english}
	\lettrine[lines=2]{S}{t. Charles} Borromeo, cardinal, bishop of Milan, and
	confessor, whose birthday is on the day previous.
\switchcolumn*
\selectlanguage{latin}
Bonóniæ sanctórum Mártyrum Vitális et Agrícolæ; quorum prior postérioris servus
	ántea fuit, póstea consors et colléga martyrii. In ipsum porro Vitálem
	...
	interemérunt. Eórum translatióni sanctus Ambrósius cum interésset, Mártyris
	clavos, sánguinem triumphálem et crucis lignum se collegísse refert, ac sub
	sacris altáribus condidísse.
\switchcolumn
\selectlanguage{english}
At Bologna, the holy martyrs Vitalis and Agricola. The former was first the
	servant of the latter, and afterwards his partner and companion in
	martyrdom. He was subjected by the persecutors to all kinds of torments, so
	that there was no part of his body without wounds. After having suffered
	with constancy, he yielded up his soul unto God in prayer. Agricola was put
	to death by being fastened to a cross with many nails. St. Ambrose relates
	that being present at the translation, he took the martyr's nails, his
	glorious blood, and the wood of his cross, and deposited them under
	consecrated altars.
\switchcolumn*
\selectlanguage{latin}
In cœnóbio Cervi 
...
\selectlanguage{latin}
Heracléæ, in Thrácia, 
 natális sanctórum Mártyrum Clementíni, Theódoti et Philómeni.
\switchcolumn
\selectlanguage{english}
...
Alexandríæ sancti 
 ...
 crudelíssimis affecérunt supplíciis, ut cunctas ei junctúras membrórum prius 
...
Cæsaréæ, in Palæstína, 
 ...
 béstias et ab iis nil læsus, tandem, lapídibus ad pedes appénsis, in mare 
 demérgitur.
\switchcolumn
\selectlanguage{english}
...
\switchcolumn*
\selectlanguage{latin}
Doróstori, in Mysia inferióre, sancti Dásii Mártyris, qui, cum in festo Satúrni
	nollet impudicítiis ejus consentíre, sub Basso Præside cæsus est.
\switchcolumn
\selectlanguage{english}
...
\switchcolumn*
\selectlanguage{latin}
Nicéæ, in Bithynia, sanctórum Mártyrum Eustáchii, Thespésii et Anatólii, in
persecutióne Maximiáni.
\switchcolumn
\selectlanguage{english}
At Nicaea in Bithynia, the holy 
 martyrs Eustace, Thespesius, and Anatolius, in the persecution of Maximianus.
\switchcolumn*
\selectlanguage{latin}
Heracléæ, in Thrácia, 
...
\switchcolumn*
\selectlanguage{latin}
Romæ sancti Móysis, Presbyteri et Mártyris; quem, cum áliis deténtum in
	cárcere, sanctus Cypriánus per lítteras sæpe est consolátus. Ipse autem
	Móyses, cum non tantum advérsus Gentíles, sed étiam advérsus schismáticos
	et hæréticos Novatiános infrácto ánimo stetísset, demum (ut sanctus
	Cornélius Papa testátur), in persecutióne Décii, exímio et admirábili
	martyrio decorátus est.
\switchcolumn
\selectlanguage{english}
